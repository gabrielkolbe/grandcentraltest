...
.header-info-list .info-main {
    color: '.$logobar_teltime.';
}

.header-info-list .info-sub {
    color: '.$logobar_emaildays.';
}
...
.header-info-list .info-sub a {
 ...
 .header-info-list .custom-icon {
    color: '.$logobar_iconcolours.';
}

.main-nav .nav-item.active .nav-link {
    color: '.$topbar_fontselected.';
}
.navbar-dark .navbar-nav .nav-link {
    color:  '.$topbar_font.';
}
.navbar-dark .navbar-nav .nav-link:focus, .navbar-dark .navbar-nav .nav-link:hover {
    color: '.$topbar_fonthover.';
}

.footer {
    background-color: '.$footerbg.';
    color: rgba('.hexrgb($footertext).', 0.7);
}

.footer .col-title {
    color: '.$footerheadings.';
}
...
.bottombar {
    ...
    color: rgba('.hexrgb($bottombartext).', 0.4);
}
...
.reviews-section .source {
    color: rgba('.hexrgb($reviewtext).', 0.8);
}
