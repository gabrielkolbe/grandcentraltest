        ...
        <div class="row mb-2 mb-xl-3">
					...
					<div class="row">
						...
						<div class="col-xl-12 col-xxl-4 d-flex">
							<div class="w-100">
								<div class="row">
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<div class="mb-0">
													<span class=" "> <i class="mdi mdi-arrow-bottom-right"></i> 5% </span>
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Emails Received</h5>
													</div>
						...
						<div class="col-12 col-md-6 col-xxl-3 d-flex order-1 order-xxl-1">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Yesterday's Analytics</h5>
								</div>
								<div class="card-body d-flex">
									<div class="align-self-center w-100">  
										<div class="chart">
