...
<input name="postit" type="hidden" value="<?php echo $encrypt->encode('register'); ?>">
<input type="hidden" name="csrf_token" value="<?php echo generate_token();?>" />

				<div class="row text-start">
        
							<div class="firstname-group col-md-6 col-12 form-group">
								<div class="form-group-inner">
									<label for="firstname">Email</label>
									<input type="text" class="form-control" name="firstname" placeholder="First Name" aria-required="true" required>
								</div>
							</div>
              
							<div class="lastname-group col-md-6 col-12 form-group">
								<div class="form-group-inner">
									<label for="lastname">Email</label>
									<input type="text" class="form-control" name="lastname" placeholder="Last Name" aria-required="true" required>
								</div>
							</div>
          ...
          <div class="col-md-6 col-12 form-group">
              ...
              <div class="col-md-6 col-12 form-group">
                   <ul>
                   <li><small><a href="/login">Login</a></small></li>
