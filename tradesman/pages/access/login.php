...
<input name="postit" type="hidden" value="<?php echo $encrypt->encode('signintosite'); ?>">
				...
				<div class="row text-start">
							...
							<div class="email-group col-md-6 col-12 form-group">
								<div class="form-group-inner">
									...
									<input type="password" class="form-control" name="password" placeholder="Your Password" aria-required="true" required>
								</div>
							</div><!--//email-group-->
